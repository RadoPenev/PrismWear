...
namespace PrismWear.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        // MODIFY YOUR CONSTRUCTOR TO INCLUDE ROLEMANAGER
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Confirmation email logic (optional / default scaffold code):
                ...
                // If there's an error in user creation, display it
